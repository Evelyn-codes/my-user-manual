...
export function Header({aside,title="本人使用说明书"}:{aside?:ReactNode;title?:string}) {return <header className="appbar"><b><ManualIcon/>{title}</b><span className="tiny">{aside}</span></header>}
