...
function renderCard(key) {
  ...
  result.innerHTML = `
    <div class="appbar"><b><svg class="manual-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 5C9 3 5 3 2 4v15c3-1 7-1 10 1 3-2 7-2 10-1V4c-3-1-7-1-10 1v15"/><path d="M5 8h4M5 12h4M15 8h4M15 12h4"/></svg> 本人使用说明书</b><span class="tiny">说明书 / ${number}</span></div>
    ${title(card)}
